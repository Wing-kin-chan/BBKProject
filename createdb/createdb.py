...
try:
    for i in range(0, len(accessions)):
        cursor.execute('INSERT INTO genes VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)',
                    (accessions[i], 
                     dates[i], 
                     loci[i], 
                     geneIDs[i], 
